...
await check('all of Pinterest needs a token',      get('/api/pinterest/everywhere?q=corsets'), 401);
await check('pin thumbs need a token',             post('/api/pinterest/thumbs', { headers: { 'Content-Type': 'application/json' }, body: '{"urls":[]}' }), 401);
