# MAYA handoff archive, v13.24 through v13.98

Moved out of docs/AI-HANDOFF.md on Aug 27 2026 (v14.02) because that file is a
state file, not a log, and had grown to 2,160 lines. Nothing here is current;
read it only when you need the story behind an old decision.
